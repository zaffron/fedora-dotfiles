...
location_id = "940d0fe0b32980dbe2dceb7c6eea4bb633a96a1de302c4f04d396bfe8b66e214"  # TODO
...
try:
    ...
    print(json.dumps({"text": "Weather Error", "tooltip": f"Failed to fetch weather data: {str(e)}"}))
    exit(1)
...
try:
    ...
    # Fallback: try to determine status from the weather phrase or use default
    status_code = "default"
...
# wind speed
wind_speed = html_data("span[data-testid='Wind']").text() or "N/A"
